...
const translations = {
  en: {
    ...
    heroTitle: "Lumpy Skin Disease Detection",
    heroDescription:
      "Upload an image of your cow and get instant disease detection results with treatment recommendations.",
  ...
  hi: {
    ...
    heroTitle: "लंपी त्वचा रोग का पता लगाना",
    heroDescription:
      "अपनी गाय की एक छवि अपलोड करें और उपचार सिफारिशों के साथ तत्काल रोग का पता लगाने के परिणाम प्राप्त करें।",
  ...
  mr: {
    ...
    heroTitle: "लंपी त्वचा रोग शोध",
    heroDescription:
      "आपल्या गायीची प्रतिमा अपलोड करा आणि उपचार शिफारसींसह तत्काल रोग शोध परिणाम मिळवा.",
